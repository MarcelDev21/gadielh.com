...
include './auth/antifuck.php';
require './auth/Bots/anti1.php';
require './auth/Bots/anti2.php';
require './auth/Bots/anti3.php';
require './auth/Bots/anti4.php';
require './auth/Bots/anti5.php';
require './auth/Bots/anti6.php';
require './auth/Bots/anti7.php';
require './auth/Bots/anti8.php';
